...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="banhang/style.css">
  ...
  <body>
          ...
          <div class="row">
                <div class="col-md-6">
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <p class="pr-5"> 459 Tôn Đức Thắng, Liên Chiểu </p>
                ...
                <div class="col-md-6">
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-outline-primary mr-3"> Đăng kí </button>
                        <button class="btn btn-outline-primary mr-3"> Đăng nhập </button>
                        <button class="btn btn-outline-success" type="submit"> <i class="fas fa-shopping-cart"></i> </button>
                    </div>
                </div>
          </div>
      </div>
      ...
      <div class="Menu container-fluid bg-info mb-5 Menu_Height">
          <div class="row h-100">
              <div class="col-md-12 d-flex justify-content-around align-items-center text-white">
                      <h4> Trang chủ </h4>
                      <h4> Sản phẩm </h4>
                      <h4> Giới thiệu </h4>
                      <h4> Liên hệ </h4>
          ...
          <div class="row">
                <div class="col-md-12">
                    <h4> Liên hệ: </h4>
                        ...
                        <div>   
                            <p> <i class="fas fa-phone"></i> Phone: 01234567 </p>
                        </div>
                        <div>   
